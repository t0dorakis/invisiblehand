...
import textCanvasTexture from "../../assets/textures/favoritDoubleSide-min.png";
...
const PageWithScene = () => {
  ...
  let loadingComponentShown = true
    ...
    const initialSetup = (scene, canvas) => {
      ...
      const spotLight = new BABYLON.SpotLight("blueSpotLight", new BABYLON.Vector3(0, 7, -20), new BABYLON.Vector3(0, 0, 0.7), Math.PI / 2, 50, scene);
