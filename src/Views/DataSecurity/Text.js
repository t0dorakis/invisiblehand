...
const Text = () => (
    ...
    <h3>Privacy Information</h3>
      ...
      <p>
        d) The purpose of data processing is to present us on the internet and to communicate with our fans, customers and business partners. The purpose of analyzing some user behavior on our website is to design the website in line with the requirements of our users and website visitors.
      </p>
        <p>
          e) The legal basis for processing the data is Art. 6 (1) lit. b) GDPR based on the contract of use of our website. The legal basis for the analysis of user behavior is Art. 6 (1) lit. f) GDPR, our legitimate interest is to provide our visitors with a demand-oriented design of our website.
        </p>
        <p>
          f) It is not possible to use our website without disclosure of protocol data such as your IP address. Protocol and communication data will not be transferred to third parties unless special circumstances require us to do so, e.g. if a criminal offence is suspected or in the course of an investigation. In these cases, data may be transferred to the police and/or the public prosecutor's office.
        </p>
      <h4>3. Communication and Contractual Obligations</h4>

      <p>
        a) When you reach out to us via email or otherwise, we process the data you provide us with for the purpose of performing our obligations with regard to our contractual relationship or its preparation and/or any other communication purposes. This also includes consulting and information requests.
      </p>
      <p>
      ...
      <p>
        b) At any time, you have the right to request information about all your Data which we are processing. Furthermore, if your Data is incorrect or incomplete, you have the right to have it rectified and completed. You can also request the erasure of your Data at any time, unless we are legally obliged to continue processing your Data.          </p>
      <p>
        c) Where applicable legal requirements are met, you can request a restriction to the processing of your Data. You also have the right to object to the processing, insofar as the data processing is based on profiling or direct marketing purposes.          </p>
      <p>
        d) Where we process your Data on the basis of your consent or a contract, you have the right to transfer the Data provided by you, insofar as the rights and freedoms of others remain unaffected. Where we process your Data on the basis of a declaration of consent, you have the right to revoke such consent at any time with future effect. The processing carried out prior to a revocation remains unaffected by the revocation.          </p>
      <p>
        e) Where you believe that we process your Data in violation of the applicable law, you have the right to file a complaint with a data protection supervisory authority at any time.          </p>
</article>);
